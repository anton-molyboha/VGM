			    ...
			    #flow direction of outEdge is considered
                                ...
                                for i in range(overshootsNo):
                                    ...
                                    if last == 3:
                                        if countNo1 < overshootsNo1:
                                            if positionPref1 == []:
                                                if len(oe['rRBC']) > 0:
                                                    posFirst = oe['rRBC'][0] if oe['sign'] == 1.0 \
                                                        else oe['length']-oe['rRBC'][-1]
                                                    if position1[index1] > posFirst-oe['minDist']:
                                                        positionPref1.append(posFirst-oe['minDist'])
                                                    else:
                                            ...
                                            if countNo2 < overshootsNo2:
                                                if positionPref2 == []:
                                                    if len(oe2['rRBC']) > 0:
                                                        posFirst = oe2['rRBC'][0] if oe2['sign'] == 1.0 \
                                                            else oe2['length']-oe2['rRBC'][-1]
                                                        if position2[index2] > posFirst-oe2['minDist']:
                                                            positionPref2.append(posFirst-oe2['minDist'])
                                                        else:
                                                ...
                                                if positionPref3 == []:
                                                    if len(oe3['rRBC']) > 0:
                                                        posFirst = oe3['rRBC'][0] if oe3['sign'] == 1.0 \
                                                            else oe3['length']-oe3['rRBC'][-1]
                                                        if position3[index3] > posFirst-oe3['minDist']:
                                                            positionPref3.append(posFirst-oe3['minDist'])
                                                        else:
                                    ...
                                    if positionPref1[-1] < 0:
                                        ...
                                        for i in range(-1,-1*(len(positionPref1)),-1):
                                            if positionPref1[i-1]-positionPref1[i] < oe['minDist'] - eps:
                                                ...
                                                break
                                        if len(oe['rRBC']) > 0:
                                            posFirst = oe['rRBC'][0] if oe['sign'] == 1.0 else \
                                                oe['length'] - oe['rRBC'][-1]
                                            if positionPref1[0] > posFirst - oe['minDist'] + eps:
                                                print('BIGERROR should not happen 5')
                                                print(posFirst)
                                                print(posFirst-oe['minDist'])
                                            ...
                                            if dist1 < oe['minDist']:
                                                ...
                                                if posNoBifEventsPref2 > countPref2 and pref2Full == 0:
                                                            ...
                                                            if len(outEdges)>2:
                                                                ...
                                                                if posNoBifEventsPref3 > countPref3 and pref3Full == 0:
                                                                    ...
                                                                    #No RBCs have been put in outEPref3 so far
                                                                        ...
                                                                        if len(oe3['rRBC']) > 0:
                                                                            posFirst = oe3['rRBC'][0] if oe3['sign'] == 1 \
                                                                                else oe3['length']-oe3['rRBC'][-1]
                                                                            if posFirst - position3[index3] < oe3['minDist']:
                                                                                position3[index3]=posFirst-oe3['minDist']
                                                    ...
                                                    #no RBCs have been put in outEPref2 so far
                                                        ...
                                                        #Check that there is no overtaking of RBCs
                                                        if len(oe2['rRBC']) > 0: 
                                                            posFirst = oe2['rRBC'][0] if oe2['sign'] == 1 \
                                                                else oe2['length']-oe2['rRBC'][-1]
                                                            if posFirst - position2[index2] < oe2['minDist']:
                                                                position2[index2]=posFirst-oe2['minDist']
					        ...
					        #Check if there is a third outEdge
                                        ...
                                        #There are not yet any new RBCs in outEdgePref
                                            ...
                                            #Check that there is no overtaking of RBCs
                                            if len(oe['rRBC']) > 0: 
                                                posFirst = oe['rRBC'][0] if oe['sign'] == 1 \
                                                    else oe['length']-oe['rRBC'][-1]
                                                if posFirst - position1[index1] < oe['minDist']:
                                                    position1[index1]=posFirst-oe['minDist']
                                            #There are no RBCs present in outE2
                                            else:
                                                #Avoid overshooting whole vessels
