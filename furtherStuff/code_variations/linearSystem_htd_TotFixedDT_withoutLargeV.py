...
__all__ = ['LinearSystemHtdTotFixedDT_withoutLargeV']
...
class LinearSystemHtdTotFixedDT_withoutLargeV(object):
        ...
        #-------------------------------------------------------------------------------------------
          ...
          #-------------------------------------------------------------------------------------------
                        ...
                        if G.vs[vi]['isCap']:
                            ...
                            #TODO and phase separation anpassen. ratio of flow rates equal ratio of RBC flows
